...
/**
 * Dialog to create a quotation (which can then be confirmed to an order)
 */
public class OrderFormDialog extends JDialog {
    ...
    private SalesService.Quotation createdQuotation;
    ...
    public OrderFormDialog(Window owner,
                          ClientService clientService,
                          ItemService itemService,
                          SalesService salesService) {
        super(owner, "Create Quotation", ModalityType.APPLICATION_MODAL);
    ...
    private void initialize() {
        ...
        top.setBackground(UIConstants.MODULE_ORDERS_BG);
        ...
        lineEditor.setBackground(UIConstants.MODULE_ORDERS_BG);
        ...
        JButton addLineBtn = UIConstants.createPrimaryButton("ADD LINE", UIConstants.loadIcon("/icons/add.png", 16));
        addLineBtn.addActionListener(e -> addLine());
        lineEditor.add(addLineBtn);
        
        JButton removeLineBtn = UIConstants.createSecondaryButton("REMOVE", UIConstants.loadIcon("/icons/delete.png", 16));
        ...
        // Lines table
        String[] cols = {"Item", "Description", "Quantity", "Unit Price"};
        ...
        JButton saveBtn = UIConstants.createSuccessButton("SAVE", UIConstants.loadIcon("/icons/save.png", 16));
        saveBtn.addActionListener(e -> onSave());
        
        JButton cancelBtn = UIConstants.createDangerButton("CANCEL", UIConstants.loadIcon("/icons/cancel.png", 16));
    ...
    private void onSave() {
        try {
            ...
            createdQuotation = salesService.createQuotation(client, lines);
            saved = true;
            
            String code = createdQuotation != null && createdQuotation.code != null
                ? createdQuotation.code
                : (createdQuotation != null && createdQuotation.id != null
                    ? String.format("QT%04d", createdQuotation.id)
                    : "(unknown)");
            JOptionPane.showMessageDialog(this,
                "Quotation " + code + " created successfully!",
                "Success",
    ...
    public SalesService.Quotation getCreatedQuotation() {
