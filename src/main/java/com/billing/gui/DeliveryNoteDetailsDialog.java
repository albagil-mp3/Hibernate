...
/**
 * Dialog for displaying complete delivery note details in a read-only format
 */
public class DeliveryNoteDetailsDialog extends BaseDetailsDialog<DeliveryNote> {
    
    private static final DecimalFormat CURRENCY_FORMAT = new DecimalFormat("#,##0.00 €");
    private static final DecimalFormat QUANTITY_FORMAT = new DecimalFormat("#,##0.00");
    
    public DeliveryNoteDetailsDialog(Frame parent, DeliveryNote deliveryNote) {
        super(parent, deliveryNote, "Delivery Note Details - " + 
            (deliveryNote.getCode() != null ? deliveryNote.getCode() : "DN-" + deliveryNote.getId()));
    }
    ...
    private JPanel createHeaderPanel() {
        ...
        TitledBorder border = BorderFactory.createTitledBorder("Document Information");
        border.setTitleFont(UIConstants.UI_FONT.deriveFont(Font.BOLD));
        border.setTitleColor(UIConstants.MODULE_DELIVERY_TEXT);
        panel.setBorder(BorderFactory.createCompoundBorder(border, BorderFactory.createEmptyBorder(8,12,8,12)));
        panel.setBackground(UIConstants.MODULE_DELIVERY_BG);
        ...
        JLabel codeValue = new JLabel(entity.getCode() != null ? entity.getCode() : "DN-" + entity.getId());
        ...
        gbc.gridx = 3; gbc.weightx = 1.0;
        String deliveredStatus = entity.getDelivered() != null && entity.getDelivered() ? "Yes" : "No";
        JLabel statusValue = new JLabel(deliveredStatus);
        statusValue.setFont(valueFont);
        statusValue.setForeground(entity.getDelivered() != null && entity.getDelivered() ? 
            new Color(0x2E7D32) : new Color(0xC62828));
        panel.add(statusValue, gbc);
        y++;

        // Invoiced Status
        gbc.gridx = 0; gbc.gridy = y; gbc.weightx = 0.0;
        JLabel invoicedLabel = new JLabel("Invoiced:");
        invoicedLabel.setFont(labelFont);
        invoicedLabel.setForeground(new Color(0x212121));
        panel.add(invoicedLabel, gbc);
        
        gbc.gridx = 1; gbc.weightx = 1.0;
        String invoicedStatus = entity.getInvoiced() != null && entity.getInvoiced() ? "Yes" : "No";
        JLabel invoicedValue = new JLabel(invoicedStatus);
        invoicedValue.setFont(valueFont);
        invoicedValue.setForeground(entity.getInvoiced() != null && entity.getInvoiced() ? 
            new Color(0x2E7D32) : new Color(0x757575));
        panel.add(invoicedValue, gbc);
    ...
    private JPanel createLinesPanel() {
        ...
        String[] columnNames = {"Item", "Description", "Quantity", "Unit Price", "Discount %", "Line Total"};
    ...
    private JPanel createTotalsPanel() {
        ...
        totalLabel.setForeground(UIConstants.MODULE_DELIVERY_TEXT);
        ...
        totalValue.setForeground(UIConstants.MODULE_DELIVERY_TEXT);
