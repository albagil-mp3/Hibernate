...
public class ItemFormDialog extends BaseFormDialog<Item> {
    
    private final ItemService itemService;
    private JTextField nameField;
    private JTextArea descriptionArea;
    private JComboBox<ItemFamily> familyComboBox;
    private JComboBox<ItemCategory> categoryComboBox;
    ...
    public ItemFormDialog(Frame parent, ItemService itemService) {
        this(parent, itemService, null);
    }
    
    public ItemFormDialog(Frame parent, ItemService itemService, Item article) {
        super(parent, article == null ? "Add New Item" : "Edit Item", true);
    ...
    private void initializeComponents() {
        ...
        // Active checkbox
        activeCheckBox = new JCheckBox("Active Item");
    ...
    protected java.awt.Component createFormPanel() {
        ...
        tabbedPane.setBackground(UIConstants.MODULE_ITEMS_BG);
    ...
    private JPanel createAdditionalDataPanel() {
        ...
        // Row 2: Image section
        gbc.gridx = 0; gbc.gridy = 1; gbc.fill = GridBagConstraints.NONE;
        panel.add(new JLabel("Item Image:"), gbc);
    ...
    private void loadComboBoxData() {
        try {
            ...
            for (ItemFamily family : itemService.getAllFamilies()) {
            ...
            for (ItemCategory category : itemService.getAllCategories()) {
            ...
            for (Unit unit : itemService.getAllUnits()) {
            ...
            for (Supplier supplier : itemService.getAllSuppliers()) {
    ...
    protected boolean saveEntity() {
        try {
            ...
            entity.setFamily((ItemFamily) familyComboBox.getSelectedItem());
            entity.setCategory((ItemCategory) categoryComboBox.getSelectedItem());
